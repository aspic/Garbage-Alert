...
Som nevnt over er spillet programmert i JavaScript fra grunnen, av uten
hjelp av eksisterenede hjelperammeverk. Dette er dels fordi
...
JavaScript-filene vil en i den ferdige versjonen ha salle bildene i én
...
kun ett menneske på gruppa har.}. Da falt valget på å implementere
